...
mod tests {
    ...
    use crate::automation::{
        ActiveHours, AutomationEngine, MissionContractInput, ScheduledRunStatus,
    };
    ...
    fn save_memory(path: &PathBuf) {
        ...
        let approval = approvals.propose(proposal_input(
    ...
    fn save_skills(path: &PathBuf) {
        ...
        let skill = registry.import_skill_file(
